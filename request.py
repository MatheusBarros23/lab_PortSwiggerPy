...
def main():
    if len(sys.argv) !=2:
        print("(+) Usage: %s https://0acd00aa04ed78348355e2a9008300d7.web-security-academy.net/" % sys.argv[0])
        print("(+) Example: %s https://0acd00aa04ed78348355e2a9008300d7.web-security-academy.net/" % sys.argv[0])
        sys.exit(-1)
